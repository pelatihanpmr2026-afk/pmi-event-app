    ...
    <main className="min-h-screen py-10 px-4 flex flex-col gap-6 items-center">
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <p className="font-body text-sm text-event-navy/70 max-w-sm">
          Pengajuan anggaran kamu sudah diterima dan menunggu diproses admin.
        </p>
      </div>
      ...
      {pengajuan.pdfUrl && (
        <a href={pengajuan.pdfUrl} download target="_blank" rel="noopener noreferrer">
      ...
      <Link href="/pengajuan-anggaran/ajukan">
        <Button variant="outline">Buat Pengajuan Baru</Button>
      </Link>
    </main>
  )
}
