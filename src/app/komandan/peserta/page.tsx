...
export default async function KomandanPesertaPage() {
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="font-body text-xs text-[var(--color-text-muted)] mt-1">
          Rekap peserta (tampilan setengah data).
        </p>
      </div>
      <KomandanPesertaPendampingDashboard tipe="PESERTA" sekolahOptions={sekolahList} />
    </div>
  )
}
