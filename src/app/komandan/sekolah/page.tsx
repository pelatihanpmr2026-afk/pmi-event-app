...
import { KomandanSekolahTable } from '@/components/komandan/komandan-sekolah-table'

export const dynamic = 'force-dynamic'

export default async function KomandanSekolahPage() {
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
          ...
          <p className="font-body text-xs text-[var(--color-text-muted)] mt-1">
            Data pendaftaran sekolah (tampilan terbatas).
          </p>
        </div>
      </div>
      <KomandanSekolahTable
        initialData={serializedData.slice(0, 20)}
        initialTotal={totalSekolah}
