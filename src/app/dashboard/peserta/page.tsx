...
export default async function DashboardPesertaPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="font-heading text-base sm:text-lg text-event-navy leading-relaxed">DATA PESERTA</h1>
        <p className="font-body text-xs text-event-navy/60 mt-1">Rekap seluruh peserta dari semua sekolah</p>
      </div>
