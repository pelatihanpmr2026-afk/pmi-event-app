...
{/* MOBILE: Card */}
        <div className="md:hidden flex flex-col gap-3">
          {fields.map((field, index) => {
            ...
            return (
              <div key={field.id} className="border-3 border-event-navy bg-white p-3 flex flex-col gap-2">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="w-7 h-7 flex items-center justify-center bg-pmi-red text-white border-2 border-event-navy disabled:opacity-30"
                  >
                    <Trash2 size={11} />
                  </button>
                </div>
                ...
                <div className="flex justify-between font-body text-xs text-event-navy pt-1 border-t-2 border-event-navy/10">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Button type="button" variant="outline" onClick={onBack} disabled={isSubmitting || isPrinting}>
          Kembali
        </Button>
        <Button
          type="button"
