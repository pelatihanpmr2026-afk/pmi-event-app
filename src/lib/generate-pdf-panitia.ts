...
export async function generatePdfPanitia(
  ...
  drawMonoSig(page, 110, bawah + 40, 'Mengetahui, Ketua Pelaksana', 'Wahyu Hidayat', regular, bold)
  drawMonoSig(page, REKAP_A4_W - 110, bawah + 40, 'Bendahara', null, regular, bold)
